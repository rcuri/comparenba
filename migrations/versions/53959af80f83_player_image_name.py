...
Revision ID: 53959af80f83
Revises: 6e58128eddaf
Create Date: 2019-09-24 18:17:05.803405
...
revision = '53959af80f83'
down_revision = '6e58128eddaf'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('player', sa.Column('player_image', sa.String(length=50), nullable=True))
...
def downgrade():
    ...
    op.alter_column('player', 'assists',
               ...
               type_=sa.REAL(),
               existing_nullable=True)
    op.drop_column('player', 'player_image')
    # ### end Alembic commands ###
